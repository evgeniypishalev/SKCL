 ...
 <div class="meta-container">
  ...
  <div v-if="rules" class="rules-section">
   ...
   <div style="margin-top: 10px;">
    <h4 class="type-title-sm" style="color: var(--color-primary-level); margin-bottom: 5px;">Levels:</h4>
    <ul style="margin-bottom: 1rem; opacity: 0.8;">
     <li v-for="rule in rules.level_rules" class="type-label-md" style="margin-bottom: 4px;">• {{ rule }}</li>
    </ul>
    <h4 class="type-title-sm" style="color: var(--color-primary-level); margin-bottom: 5px;">Records:</h4>
    <ul style="opacity: 0.8;">
     <li v-for="rule in rules.record_rules" class="type-label-md" style="margin-bottom: 4px;">• {{ rule }}</li>
    </ul>
   </div>
  </div>
  </div>
